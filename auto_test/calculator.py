...
from dpgen.auto_test.CP2K import CP2K
...
def make_calculator(inter_parameter, path_to_poscar):
    ...
    elif inter_type == "cp2k":
        return  CP2K(inter_parameter, path_to_poscar)
    elif inter_type in ["deepmd", "meam", "eam_fs", "eam_alloy", "mace"]:
